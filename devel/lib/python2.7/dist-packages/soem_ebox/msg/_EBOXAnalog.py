...
"""autogenerated by genpy from soem_ebox/EBOXAnalog.msg. Do not edit."""
import codecs
import sys
...
class EBOXAnalog(genpy.Message):
  _md5sum = "da0d2d69b62902fa94381342826fb037"
  _type = "soem_ebox/EBOXAnalog"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """float32[2] analog
"""
  __slots__ = ['analog']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(EBOXAnalog, self).__init__(*args, **kwds)
