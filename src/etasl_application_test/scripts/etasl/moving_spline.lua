...
eq_r   		= ctx:createInputChannelScalar("eq_r" ,0)
endpose   = ctx:createInputChannelScalar("endpose")
...
spl        = CubicSpline(0)
spl:readPoints(rospack_find("etasl_application_test").."/scripts/etasl/motion_models/hole_in_cylinder_contour.csv"," \t,",0)
spl:setInput(s)
